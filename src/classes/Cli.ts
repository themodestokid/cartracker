...
class Cli {
  ...
  constructor(vehicles: (WheeledVehicle)[]) {
  ...
  getSelectedVehicle(): WheeledVehicle | undefined {
  ...
  performActions(): void {
    const selectedVehicle: WheeledVehicle | undefined = this.getSelectedVehicle();
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          if (selectedVehicle instanceof WheeledVehicle)
